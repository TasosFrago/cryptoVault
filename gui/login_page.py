...
class LoginPage(gui.base_page.BasePage):
    def __init__(self, parent, controller):
        ...
        ttk.Label(form_area, text="User Login", style="SubHeader.TLabel").grid(row=0, column=0, columnspan=3, pady=(0, 25), sticky="w")
        ...
        login_btn = ttk.Button(button_frame, text="Login", command=lambda: controller.attempt_login(self.username_var.get(), self.cert_file_var.get()))
        login_btn.pack(side=tk.LEFT, padx=5, ipady=4, ipadx=10)
