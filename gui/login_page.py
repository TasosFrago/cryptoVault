...
class LoginPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(self, text="Login Page", font=('Helvetica', 16)).grid(row=0, column=0, columnspan=3, pady=20, padx=10)
        ...
        login_btn = ttk.Button(self, text="Login",
                               command=lambda: controller.attempt_login(self.username_var.get(), self.cert_file_var.get()))
        login_btn.grid(row=3, column=0, columnspan=3, pady=20)
